...
const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    commonCounteredBy: 'is commonly countered by',
    commonCounters: ' commonly counters',
    commonSynergy: 'Common Best Partners',
    commonPrefix: 'Common',
    commonCounter: 'Common Counter',
    commonCountered: 'Commonly Countered',
    ...
    snapshotFeatureDesc: 'Click the camera icon to save current hero selection, click the history icon to view or restore previous snapshots.',
