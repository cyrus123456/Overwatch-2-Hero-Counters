...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    panDesc: 'Pan: Arrastrar para mover',
  ...
  fr: {
    ...
    panDesc: 'Pan: Glisser pour déplacer',
  ...
  de: {
    ...
    panDesc: 'Pan: Ziehen zum Bewegen',
    hardCounter: 'Hart',
    strongCounter: 'Stark',
    softCounter: 'Leicht',
  ...
  pt: {
    ...
    panDesc: 'Pan: Arrastar para mover',
    hardCounter: 'Contra Dura',
  ...
  ru: {
    ...
    tankBrief: 'Высокое Здоровье, Танк',
    ...
    panDesc: 'Пан: Тянуть для движения',
    hardCounter: 'Хард',
  ...
  it: {
    ...
    panDesc: 'Pan: Trascinare per muovere',
