  ...
  return (
    <TooltipProvider>
      <div className="h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100 flex flex-col overflow-hidden font-sans">
        {/* Header */}
        <header className="border-b border-slate-700 bg-slate-900/70 backdrop-blur-sm z-50 flex-shrink-0">
...
{/* 左侧地图卡片面板 - 抽屉 */}
          <div className={`absolute top-4 bottom-4 left-4 z-10 flex flex-col w-96 pointer-events-none transition-transform duration-300 ease-in-out ${isDrawerOpen ? 'translate-x-0' : '-translate-x-80'}`}>
            ...
            <button
              ...
              className="absolute -right-12 top-1/2 -translate-y-1/2 z-20 w-7 h-14 bg-slate-900/60 backdrop-blur-md hover:bg-slate-800 border border-slate-700 rounded-lg flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200 group pointer-events-auto"
            ...
            <div className="flex-1 overflow-hidden pointer-events-auto h-full relative">
              <Card className="p-3 bg-slate-900/98 border-slate-700 backdrop-blur-md shadow-xl h-full flex flex-col gap-1 rounded-xl border">
          ...
          <div className="flex-1 relative overflow-hidden bg-slate-950/20">
            ...
            <div className="absolute top-6 left-[calc(50%+28px)] -translate-x-1/2 z-20 flex items-center gap-2 bg-slate-900/60 backdrop-blur-md border border-slate-700 p-1.5 rounded-full shadow-2xl pointer-events-auto">
              <Button 
